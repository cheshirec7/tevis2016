...
class JqueryCountdownTimerBlock extends BlockBase {
  ...
  public function build() {
    ...
    $date=new DateTime($this->configuration['countdown_datetime']);
    $m = '<div class="cdate">–&nbsp;&nbsp;'.$date->format('F jS, Y').'&nbsp;&nbsp;'.$date->format('H:ia').'&nbsp;&nbsp;–</div>';

    $build = array();
    $build['content'] = array(
      '#markup' => '<div id="jquery-countdown-timer"></div>'.$m,
    );
