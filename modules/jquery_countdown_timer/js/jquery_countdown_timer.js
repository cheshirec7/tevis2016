...
(function($){
	...
	function init(elem, options){
		elem.addClass('countdownHolder').css({ 'font-size': options.font_size+'px','line-height':options.font_size+'px'});

		// Creating the markup inside the container
		//$.each(['Weeks','Days','Hrs','Mins','Secs'],function(i){
		$.each(['Weeks','Days','Hrs','Mins'],function(i){
